...
app.controller('InsiderListCtrl', ['$scope', '$http', '$state', '$stateParams', '$timeout', 'global', function ($scope, $http, $state, $stateParams, $timeout, global) {
  ...
  $scope.departmentList = [
  	'北京市公安厅', '天津市公安厅','河北省公安厅','山西省公安厅',
	  '内蒙古自治区公安厅', '辽宁省公安厅','吉林省公安厅','黑龙江省公安厅',
	  '上海市公安厅', '江苏省公安厅','浙江省公安厅','安徽省公安厅',
	  '福建省公安厅', '江西省公安厅','山东省公安厅','河南省公安厅',
	  '湖北省公安厅', '湖南省公安厅','广东省公安厅','广西壮族自治区公安厅',
	  '海南省公安厅', '重庆市公安厅','四川省公安厅','贵州省公安厅',
	  '云南省公安厅', '西藏自治区公安厅','陕西省公安厅','甘肃省公安厅',
	  '青海省公安厅', '宁夏回族自治区公安厅','新疆维吾尔自治区公安厅'
  ]
